...
You can download precompiled versions of the program from the project's [Releases](https://github.com/Bry254/vosk-tts-overlay/releases).

Development builds generated by **GitHub Actions** are also available from the [Actions](https://github.com/Bry254/vosk-tts-overlay/actions) section. These builds are generated automatically and can be downloaded from the **Artifacts** of each workflow run.
...
Puedes descargar versiones precompiladas del programa desde las [Releases](https://github.com/Bry254/vosk-tts-overlay/releases) del proyecto.

También puedes encontrar compilaciones de desarrollo generadas mediante **GitHub Actions** en la sección de [Actions](https://github.com/Bry254/vosk-tts-overlay/actions). Estas compilaciones se generan automáticamente y pueden descargarse desde los **Artifacts** de cada ejecución del workflow.
